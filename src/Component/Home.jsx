...
<p className="card-text"><strong>Description:</strong> Watch Latest Movies and TV Series.</p>
</div>
...
<p className="card-text"><strong>Description: </strong>The Plot revolves around a gym trainer and all the female members in the gym.</p>
</div>
...
<p className="card-text"><strong>Description: </strong>In 1909, two explorers fight to survive after they're left behind while on a Denmark expedition in ice-covered Greenland.</p>
</div>
...
<p className="card-text"><strong>Description:</strong> When a housewife with a personality disorder is taken hostage by a terrorist on the loose and a husband accused of cheating on his wife.</p>
</div>
...
<p className="card-text"><strong>Description: </strong>The lines between love and obsession blur in this romantic thriller packed with unpredictable twists and sharp turns.</p>
</div>
...
<p className="card-text"><strong>Description:</strong> A van carrying crores of cash. One rainy night in the outskirts of Mumbai. Unaware of each other, three stray gangs cross paths on the hunt. </p>
</div>
